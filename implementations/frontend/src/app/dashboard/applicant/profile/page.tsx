      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-6">
        ...
        <form onSubmit={handleSubmit(onSave)} className="space-y-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <textarea id="experience" rows={3} className="w-full rounded-xl border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary" {...register('experience')} />
          </div>
